...
export const {useAddBookMutation, useGetBooksQuery, useGetBookByIdQuery, useDeleteBookMutation, usePostCommentMutation, useUpdateBookMutation, useApproveBookMutation} = bookAPI;